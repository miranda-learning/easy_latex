	...
	Widget build(BuildContext context) {
		try {
			return LatexRenderWidget(
				...
				renderContext: RenderContext(font: customFont, fontSize: fontSize, color: color, locale: locale),
			...
			return Text(
				text,
				style: TextStyle(fontSize: fontSize, color: Colors.yellow, backgroundColor: Colors.red),
			);
		}
	}
}