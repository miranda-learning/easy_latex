...
class ErrorNode extends LatexRenderNode {
	...
	ErrorNode({
		...
		switch (errorVisualization) {
		  case ErrorVisualization.showInvalidSyntax:
				_child = TextNode(msg, color: const Color(0xFFFFEB3B), bgColor: const Color(0xFFF44336));
				break;
	...
	String toStringWithIndent(String indent) {
		String str = '$indent$runtimeType: w: ${size.width}, h: ${size.height}, visualization: ${errorVisualization.name}, baseline: ${baselineOffset.toStringAsFixed(2)}';
		return str;
	}
}