...
class ColonEqqNode extends LatexRenderNode {
	...
	void paint(Canvas canvas, double start, double baseline) {
		...
		canvas.drawCircle(Offset(start + radius + horizontalPadding, baseline - fontSize*0.09), radius, paint);
		canvas.drawCircle(Offset(start + radius + horizontalPadding, baseline - fontSize*0.39), radius, paint);
