...
enum IntegralType {
	...
	bool get isContour => this == contour || this == contourDouble || this == contourTriple || this == contourQuad;
}
...
class IntNode extends LatexRenderNode {
	...
	void performLayout(RenderContext renderContext, {isDense = false}) {
		...
		_integralPainter = IntegralPainter(renderContext, type: type, isInline: isInline);
