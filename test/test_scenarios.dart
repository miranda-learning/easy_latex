Map<String, dynamic> get easyLatexTestScenarios => {
      'renderTests': {
        ...
        'brackets': {
          ...
          r'brackets 2':
              r'\llbracket 5 \rrbracket \llbracket \frac{1}{2} \rrbracket',
          r'brackets 3':
        ...
        'integral': {
          r'\int':
              r'\int_1^2 \iint_1^2 \iiint_1^2 \iiiint_1^2 \intop_1^2', // TODO intop not correctly implemented yet
          r'\oint': r'\oint_1^2 \oiint_1^2 \oiiint_1^2 \oiiiint_1^2',
          r'\smallint':
              r'\smallint_1^2 \intinline_1^2', // TODO smallint not correctly implemented yet
        },
        'matrix': {
          r'matrix 1':
        ...
        'functions': {
          ...
          r'\arcsec, \arccsc, \arccot':
              r'\arcsec(x) \  \arccsc(x) \  \arccot(x)',
          r'\sinh, \cosh, \tanh, \coth':
              r'\sinh(x) \  \cosh(x) \  \tanh(x) \  \coth(x)',
          r'\nCr, \mod': r'\nCr(x) \  \mod(x)',
          r'\arg, \sgn, \deg, \dim': r'\arg \  \sgn \  \deg \  \dim',
          r'\hom, \ker, \gcd, \det, \Pr':
              r'\hom \  \ker \  \gcd \  \dim \  \Pr',
        },
        'latexCommands': {
          // Special letters
          ...
          r'cmd 20':
              r'a \preccurlyeq b \curlyeqprec c \precsim d \precapprox e',
          r'cmd 21':
              r'a \succcurlyeq b \curlyeqsucc c \succsim d \succapprox e',
        ...
        'mathpix': {
          ...
          r'mathpix 52':
              r'\supseteq \supseteqq \supsetneq \supsetneqq \swarrow',
